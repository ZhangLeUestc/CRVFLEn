...
function initRFTracker (sample,label,fuzzy_weight)
...
RF_tracker.clsf=ClusteringRF_train(sample,label,'nvartosample', mtry,'ntrees',ntree,'replace',0);    
            save temp sample label  
